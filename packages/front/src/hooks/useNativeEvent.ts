...
export function useNativeEvent (el: EventTarget | Ref<EventTarget | null | undefined> | null | undefined, eventName: string, callback: (...args: any) => any, once = false, options?: AddEventListenerOptions | boolean): void {
