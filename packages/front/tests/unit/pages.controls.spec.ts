...
const ROUTES: Record<string, { status?: number; body?: unknown }> = {
	...
	'/api/shares/audit/p1': { body: { peerId: 'p1', peerName: 'Bob', trust: 'friend', libraries: [{ libraryId: 'l1', name: 'Shows', itemCount: 10, metadataOnly: true }] } },
